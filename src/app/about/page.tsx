    ...
    return (
        <div className="min-h-screen flex flex-col bg-gradient-to-b from-purple-100 to-blue-100 relative overflow-hidden">
            ...
            <nav className="bg-gradient-to-r from-purple-300 to-sky-300 shadow-md relative z-10">
                <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                    <div className="flex items-center space-x-4">
                        <Image src={logo} alt="Logo do projeto" width={80} height={80} className="rounded" />
            ...
            <main className="flex-grow max-w-4xl mx-auto px-6 py-12 sm:px-4 space-y-10 relative z-10">
                <h2 className="text-4xl font-extrabold text-gray-900 border-b-4 border-purple-300 pb-2">
                    Sobre o Projeto
                </h2>
                ...
                <h3 className="text-2xl font-bold text-gray-900 border-b-4 border-blue-300 pb-2">
                    Desenvolvedores
                </h3>

                <div className="flex flex-col space-y-10">
                    {/* João */}
                    <div className="flex items-center bg-white rounded-lg shadow-md p-6 transition-transform duration-300 hover:scale-105 border-4 border-blue-300">
                        <img
                        ...
                        />
                        <div>
                            <h4 className="text-2xl font-semibold text-gray-800 mb-3">João Oliveira</h4>
                    ...
                    {/* Raquel */}
                    <div className="flex items-center bg-white rounded-lg shadow-md p-6 transition-transform duration-300 hover:scale-105 border-4 border-purple-300">
                        <img
                        ...
                        />
                        <div>
                            <h4 className="text-2xl font-semibold text-gray-800 mb-3">Raquel Marafon</h4>
                            <p className="text-base text-gray-700 mb-1">
                                Email:{' '}
